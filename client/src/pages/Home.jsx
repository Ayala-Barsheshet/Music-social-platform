...
// import "./SongSearchPage.css"; // משתמשים באותו CSS של דף החיפוש
...
//   useEffect(() => {
//     APIRequests.getRequest("songs/recommended").then(setRecommendedSongs);
//     APIRequests.getRequest("songs/recent").then(setRecentSongs);
//   }, []);
